...
cohort1 = readRDS("jesslyn_ovca/data/Izar_2020/Izar_2020_10x.RDS")
cohort2 = readRDS("jesslyn_ovca/data/Izar_2020/Izar_2020_SS2.RDS")

# Read in gene lists
hkgenes = read_lines("jesslyn_ovca/data/gene_lists/tirosh_house_keeping.txt", skip = 2)
ccgenes = read_lines("jesslyn_ovca/data/gene_lists/regev_lab_cell_cycle_genes.txt")
...
```{r treatmentInfo}
supptab1 = read_excel("jesslyn_ovca/data/Izar_2020/Table_S1_FINAL_Rev3.xlsx")
...
supptab2 = read_excel("jesslyn_ovca/data/Izar_2020/Table_S2.xlsx", skip=2) #make 2nd the header
