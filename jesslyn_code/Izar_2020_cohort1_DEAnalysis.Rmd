...
Idents(cohort1Malignant) <- "treatment.Status"
OTvsNaive.markers <- FindMarkers(cohort1Malignant, ident.1 = "Treatment-naive", ident.2 = "On-treatment", min.pct = 0.1, logfc.threshold = 0)
...
CvsNaive.markers <- FindMarkers(cohort1Malignant, ident.1 = "Treatment-naive", ident.2 = "After 1 cycle of chemotherapy", min.pct = 0.1, logfc.threshold = 0)
