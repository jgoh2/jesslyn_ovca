...
fresh2_md <- vroom("data/HTAPP/HTAPP-624-SMP-3212_fresh_channel1_Seurat_meta_data.csv", delim = ",") %>% 
  column_to_rownames("...1") 
fresh2_genes <- vroom("data/HTAPP/geneNames/HTAPP-624-SMP-3212_fresh_channel1_Seurat_data_geneNames.csv", delim = ",") %>% pull(x) #pull takes a column and makes it into a vector
