...
p1 <- ggpairs(P8.PCA.cells, columns = c("PC_1", "PC_2", "PC_3", "PC_4", "PC_5"), diag = "blank", mapping = aes(alpha = 0.3, colour = Oxphos.ctg)) + 
  labs(title = "Investigating the PC that captures OXPHOS scores variation across cells (PC1-PC5)")

p1

p2 <- ggpairs(P8.PCA.cells, columns = c("PC_6", "PC_7", "PC_8", "PC_9", "PC_10"), diag = "blank", mapping = aes(alpha = 0.3, colour = Oxphos.ctg)) + 
