...
**PART 1: PC LOADINGS FROM PC1-PC5 OPTION i** 
...
#DF20 -----------------------------------
DF20.pc.go1 <- vector("list", length = 5)
...
#DF101 -----------------------------------
DF101.pc.go1 <- vector("list", length = 5)
...
#DF68 -----------------------------------
DF68.pc.go1 <- vector("list", length = 5)
...
PCs <- c("PC_1", "PC_2", "PC_3", "PC_4", "PC_5")
j.PCs <- c("PC1", "PC2", "PC3", "PC4", "PC5")
background <- rownames(PDX_All@assays$RNA@counts)

#DF20 -----------------------------------
DF20.pc.go2 <- vector("list", length = 5)
...
#DF101 -----------------------------------
DF101.pc.go2 <- vector("list", length = 5)
...
#DF68 -----------------------------------
DF68.pc.go2 <- vector("list", length = 5)
