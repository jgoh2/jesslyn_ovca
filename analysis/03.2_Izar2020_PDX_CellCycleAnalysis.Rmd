...
```{r cellcycleVln, message=FALSE, warning=FALSE, fig.align='center', fig.width=10, fig.height=8}
#VlnPlot -------------------------
...
if(obj == "DF101"){
  p <- VlnPlot(PDXs[[i]], features = c("S.Score.centered", "G2M.Score.centered"), group.by = "treatment.status", pt.size = 0, combine = F, y.max = 4.3, cols = c("#00AFBB", "#E7B800", "#FC4E07"))
}
else{
  p <- VlnPlot(PDXs[[i]], features = c("S.Score.centered", "G2M.Score.centered"), group.by = "treatment.status", pt.size = 0, combine = F, y.max = 4, cols = c("#00AFBB", "#E7B800", "#FC4E07"))
}
